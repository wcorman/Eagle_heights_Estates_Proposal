...
### Preset E — "Prairie Horizon" (Modern Prairie Estate)
- **Identity:** A quiet prairie sanctuary where modern homes meet open skies and expansive land, understated luxury rooted in calm space and natural light.
- **Palette:** Prairie Pine `#334A3F` (Primary), Wheat `#D8C6A0` (Accent), Warm Sand `#EEE9E1` (Background), Deep Earth `#1E2421` (Text/Dark)
- **Typography:** Headings: "Sora" + "DM Sans" (slightly wide tracking). Drama: "Cormorant Garamond" Italic. Data: "IBM Plex Mono".
- **Image Mood:** prairie grass, big sky horizon, golden wheat fields, quiet gravel roads, modern prairie homes, sunset light across open land, aerial farmland geometry.
- **Hero line pattern:** "[Living noun] beneath the" (Bold Sans) / "[Open sky]." (Massive Serif Italic)
...
Three cards derived from the user's 3 value propositions. These must feel like **functional micro-UIs**, not static marketing cards. Each card gets one of these interaction patterns:
